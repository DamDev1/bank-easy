...
export default function Withdraw() {
  ...
  useEffect(() => {
    if (selectedOption && inputAmount && phoneNumber) {
        setIsBankTransfer(true);
    }
  }, [selectedOption, inputAmount, phoneNumber]);
    ...
    <PlatformView className="bg-secondary" scrollable>
      ...
      <View className="flex-1 p-5 -mt-10">
        ...
        <View className="gap-5 mt-10">
          ...
          <View>
            <Input type="text" placeholder="Phone number" onChangeText={(text) => setPhoneNumber(text)}/>
          </View>
          <View>
